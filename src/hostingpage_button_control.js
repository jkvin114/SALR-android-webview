...
$(document).ready(function () {
	...
	$(".champmenu a").click(function () {
		...
		switch (champ) {
			case 0:
				$(aichamp[selectedmenu]).attr("src", "img/character/reaper.png")
				break
			case 1:
				$(aichamp[selectedmenu]).attr("src", "img/character/elephant.png")
				break
			case 2:
				$(aichamp[selectedmenu]).attr("src", "img/character/ghost.png")
				break
			case 3:
				$(aichamp[selectedmenu]).attr("src", "img/character/dinosaur.png")
				break
			case 4:
				$(aichamp[selectedmenu]).attr("src", "img/character/sniper.png")
				break
			case 5:
...
function showTeamPage(isforguest) {
	...
	for (let i = 0; i < 4; ++i) {
		console.log(myturn)
		console.log(sessionStorage.host)
		if (i !== myturn && sessionStorage.host !== "simulation") {
...
function receiveMap(map) {
	if (myturn !== 0 && sessionStorage.host !== "simulation") {
		$(".mapbtn").hide()
